...
| <a id="detail-handoff"></a>**`/handoff`** — route a discussion to the right worker | active — building on `feat/handoff-v1`; single-target validated by hand 2026-07-10; fan-out needs: parent/child (shipped, PR #17) | [detail](roadmap-handoff.html) | Switch to an existing agent's session or `wb new` it |
